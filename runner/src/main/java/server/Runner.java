...
import server.handler.ExceptionsHandler;
...
//                KafkaSocketProducerConfig.class,
//                OrderBuzConfig.class,
//                ActiveMQConsumer.class,
//                RestApiConfig.class,
//                OrderKafkaConfig.class);
...
//        template.send("","");
        ...
        commonServer.register(new ServiceHandler());
